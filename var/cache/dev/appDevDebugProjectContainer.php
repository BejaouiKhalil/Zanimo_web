...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_0d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079b' => 'get10d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079bService',
            '2_0d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079b' => 'get20d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079bService',
        ...
        $this->privates = array(
            '1_0d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079b' => true,
            '2_0d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079b' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_0d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079b']) ? $this->services['1_0d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079b'] : $this->get10d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079bService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_0d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079b']) ? $this->services['2_0d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079b'] : $this->get20d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079bService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'zanimo', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->get('annotation_reader')) && false ?: '_'}, array(0 => ($this->targetDirs[3].'\\src\\AccessoryBundle\\Entity'))), 'AccessoryBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('AccessoryBundle' => 'AccessoryBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_a1c21f92128060a7444c56fb59c7915a47babed8bb97a663a1e938b3fb5e9c2c');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\AccessoryBundle/Resources/views'), 'Accessory');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6d99e1d31032607d2e059a14a40e3dcf3e05799f');
    }
    ...
    /**
     * Gets the private '1_0d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079b' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get10d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079bService()
    {
        return $this->services['1_0d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079b'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_0d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079b' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get20d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079bService()
    {
        return $this->services['2_0d3fb896938556e7da87d7ed09c2b56ecda023f238f5c511b7947d177477079b'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('pFx29gH4YM', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('s7eZRg2kGc', 0, 'ku+2qqZzguCyH7psBGXTnx', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4zAhPLS0xH', 0, 'ku+2qqZzguCyH7psBGXTnx', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vH22Nw6M6o', 0, 'ku+2qqZzguCyH7psBGXTnx', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a777615f2da28.92095289');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'AccessoryBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\AccessoryBundle'),
                    'namespace' => 'AccessoryBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            case 'img_directory': $value = ($this->targetDirs[3].'/web/uploads'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AccessoryBundle' => 'AccessoryBundle\\AccessoryBundle',
            ...
            'secret' => '6d99e1d31032607d2e059a14a40e3dcf3e05799f',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '6d99e1d31032607d2e059a14a40e3dcf3e05799f',
